      ...
      <div className='flex flex-1 flex-col  gap-4'>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex space-x-8'>
            <button onClick={() => setSelect('S') } className={`rounded-lg px-4 py-2 dark:bg-black/70 bg-white/70 outline-500 ${select=== "S" ? "border border-blue-500" : ""}`}>S</button>
            <button onClick={() => setSelect('M') } className={`rounded-lg px-4 py-2 dark:bg-black/70 bg-white/70 outline-500 ${select=== "M" ? "border border-blue-500" : ""}`}>M</button>
            <button  onClick={() => setSelect('L') } className={`rounded-lg px-4 py-2 dark:bg-black/70 bg-white/70 outline-500 ${select=== "L" ? "border border-blue-500" : ""}`}>L</button>
            <button  onClick={() => setSelect('XL') } className={`rounded-lg px-4 py-2 dark:bg-black/70 bg-white/70 outline-500 ${select=== "XL" ? "border border-blue-500" : ""}`}>XL</button>
          </div>
        </div>
        <button className='my-6 outline-0 bg-blue-500 py-4 px-2 text-white rounded-xl'>ADD TO CART</button>
